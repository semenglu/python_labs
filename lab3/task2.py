...
def safe_float_input(prompt):
    while True:
        ...
        try:
            ...
            print(f"Введено недопустимое значение: '{input_str}'. Пожалуйста, введите числовое значение.")

def get_triangle_data():
    base = safe_float_input("Введите основание треугольника: ")
    height = safe_float_input("Введите высоту треугольника: ")
    return base, height

def get_rectangle_data():
    width = safe_float_input("Введите ширину прямоугольника: ")
    height = safe_float_input("Введите высоту прямоугольника: ")
    return width, height

def get_movement_data():
    dx = safe_float_input("На сколько единиц переместить по оси X? ")
    dy = safe_float_input("На сколько единиц переместить по оси Y? ")
    return dx, dy
